...
A good approximation of a 50% chance of a match is \\( \sqrt{d} \\) where \\( d = 365 \\). That gives us 19 people needed for a 50% chance at a match. Kind of close to the actual answer of 23, but it doesn't really matter much when dealing with huge numbers like the SHA-1 domain.
