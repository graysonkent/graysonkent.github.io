...
var index = lunr(function () {
    ...
    index.add({
      title: "Installation",
      category: ["docs","help"],
      content: "\n    \n\n\nI assume you have already downloaded and installed Ruby. Here’s what you need to do next:\n\n\n  Install the jekyll-paginate plugin using gem install jekyll-paginate. This plugin is mandatory for the theme to work.\n  Copy the theme in your desired folder.\n  Enter into the folder by executing cd name-of-the-folder.\n  If you want to access and customize the theme, use jekyll serve. This way it will be accessible on http://localhost:4000. If you want just to build your _site folder, use jekyll build.\n  Upload the content of the compiled _site folder on your host server.\n\n",
...
var store = [{
    "title": "Documentation - Configuration & First Steps",
    "link": "/03-20-2016/docmentation.html",
    "image": null,
    "date": "March 20, 2016",
    "category": ["docs","help"],
    ...
    "title": "Installation",
    "link": "/03-16-2016/installation.html",
    "image": null,
    "date": "March 16, 2016",
    "category": ["docs","help"],
    "excerpt": "I assume you have already downloaded and installed Ruby. Here’s what you need to do next: Install the jekyll-paginate plugin..."
},{
    "title": "What is Jekyll?",
    "link": "/03-15-2016/what-is-jekyll.html",
    "image": null,
    "date": "March 15, 2016",
    "category": ["docs"],
    ...
    "title": "Sample Data",
    "link": "/03-11-2016/sample-data.html",
    "image": null,
    "date": "March 11, 2016",
    "category": ["docs"],
